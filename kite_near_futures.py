...
class KiteNearFutures:
                ...
                try:
                    ...
                    if (instrument_type == 'FUT' and 
                        ...
                        try:
                            ...
                            # Only near month futures (36-70 days)
                            if 36 <= days_diff <= 70:
                                contract = {
    ...
    def fetch_live_data(self, use_ltp_only=True, limit_contracts=None):
        """Fetch live data for near futures"""
        try:
            ...
            print(f"📈 Fetching live data for {len(contracts)} near futures...")
    ...
    try:
        ...
        while True:
            try:
                ...
                near_futures.fetch_live_data(use_ltp_only=True, limit_contracts=50)
                near_futures.display_live_data(limit=30)
